...
###2. Star Wars characters: transition_manual, transition_layers
...
Try using different enter_ options to change how the layers appear (e.g. enter_fade()). *Note*: exit_ options also exist, but since the layers are NOT exiting, it's NA here. 
...
g. An transition_layers example with previous layers NOT retained (and exit_ updated)
